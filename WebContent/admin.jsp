...
<%@ page session="true"%> <%-- Enables admin-only access control --%>
...
<%
    ...
    // Error message passed from AddCourseServlet
...
<div class="bg-[#005461]/80 backdrop-blur-xl text-white rounded-3xl shadow-2xl p-12 space-y-12">
    ...
    <section>
        ...
        <%-- Display validation errors from servlet --%>
        <% if(errorMessage != null) { %>
            <div class="bg-red-600 p-3 rounded-lg mb-4">
                <%= errorMessage %>
            </div>
        <% } %>

        <!-- POST → AddCourseServlet -->
        <form action="AddCourseServlet" method="post"
            ...
            <!-- Teacher list populated from users collection -->
    ...
    <section class="bg-white/90 text-[#005461] rounded-2xl p-8 shadow-xl">
        ...
        <table class="w-full border-collapse text-lg">
            <thead class="bg-[#005461] text-white text-xl">
                <tr>
            ...
            %>
                <tr class="border-b even:bg-gray-50">
                    ...
                    <!-- Edit & Delete → respective servlets -->
                    <td class="px-5 py-3">
                        <div class="flex justify-center gap-3">
                            ...
                            <form action="EditCourseServlet" method="get">
                                ...
                                <button class="bg-[#005461] text-white px-4 py-2 rounded-lg shadow">
                                    Edit
                                </button>
                            </form>
                            ...
                            <form action="DeleteCourseServlet" method="post"
                                ...
                                <input type="hidden" name="courseCode"
                                       value="<%= c.getString("code") %>">
                                <button class="bg-red-600 text-white px-4 py-2 rounded-lg shadow">
                                    Delete
                                </button>
                            </form>
